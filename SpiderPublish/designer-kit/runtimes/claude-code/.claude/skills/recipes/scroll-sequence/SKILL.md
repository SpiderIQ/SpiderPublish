...
description: "Build a cinematic scroll-scrubbed hero from a video file using ffmpeg frame extraction and the sys-scroll-sequence component. Use whenever the user asks for 'cinematic scroll', 'scroll-linked hero', 'video as background animation', 'frame-by-frame hero', 'scroll-driven animation', 'Apple-style scroll hero'."
---
