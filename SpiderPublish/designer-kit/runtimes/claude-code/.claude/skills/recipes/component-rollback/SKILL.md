...
description: "Restore a component to an earlier version's content. Creates a new forward version + repoints pages. Pairs with component-update-and-propagate for undo (v2.88.0+). Use whenever a component change broke pages."
---
