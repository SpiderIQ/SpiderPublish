...
This kit ships **25 pre-built Knowledge Items** under [knowledge-items/](./knowledge-items/) covering capability discovery, page creation, marketplace search, deploy, personalized landing, booking, scroll-sequence, GEO readability, MCP package picking, CLI reference, and IDE extension setup. Install with `bash install-knowledge-items.sh`.
...
- [Forms — Multi-Step Form Authoring MCP Surface](knowledge-items/21-spideriq-forms/) — Full form_* MCP namespace: Typeform-class multi-step forms, lead capture, NPS / CSAT surveys, intake forms.
...
- [Forms — Premium Design Guide](knowledge-items/25-spideriq-forms-design-guide/) — Author polished Forms with theme presets, layout variants, field-level styling overrides, welcome / thank-you screens, progress indicators, transitions, brand assets, accessibility, and the 14-rule validator.
