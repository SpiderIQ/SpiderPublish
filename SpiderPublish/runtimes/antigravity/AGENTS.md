...
This kit ships **22 pre-built Knowledge Items** under [knowledge-items/](./knowledge-items/) covering capability discovery, page creation, marketplace search, deploy, personalized landing, booking, scroll-sequence, GEO readability, MCP package picking, CLI reference, and IDE extension setup. Install with `bash install-knowledge-items.sh`.
...
- [Bootstrap a Form from a Seed Template](knowledge-items/22-spideriq-form-from-template/) — Bootstrap a publishable SpiderFlow form from one of 5 seeded global templates (lead-gen-quiz / contact / nps / job-application / event-rsvp) in a single agent-callable step.
...
- [SpiderFlow — Multi-Step Form Authoring (GA, P1 closure)](knowledge-items/21-spideriq-forms/) — Full form_* MCP namespace (GA 2026-05-14, P1 closure).
