---
name: booking
description: "Full booking_* MCP namespace: cal.com-backed flow authoring, services, bookings, template library. Ships /book/{flow_id} route + {% booking %} Liquid tag. Use whenever the user asks for 'add appointment booking', 'calendar embed', 'scheduling flow', 'cal.com integration'."
---
# booking
