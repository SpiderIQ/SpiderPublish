...
description: "Update a shared component AND repoint every consuming page's block pin in one MCP call + one confirm_token (v2.88.0+). Replaces the ~10-request choreography. Use whenever you change a component everyone is using."
---
