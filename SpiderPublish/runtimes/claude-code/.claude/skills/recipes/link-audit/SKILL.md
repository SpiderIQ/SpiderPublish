---
name: link-audit
description: "Scan the tenant's published surface for broken internal links (404s, redirects, mistyped slugs) before deploy. Use whenever you finish authoring and want a pre-deploy sanity check."
---
# recipes/link-audit
