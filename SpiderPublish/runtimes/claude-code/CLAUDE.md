...
- [Forms — Multi-Step Form Authoring MCP Surface](.claude/skills/core/forms/SKILL.md) — Full form_* MCP namespace: Typeform-class multi-step forms, lead capture, NPS / CSAT surveys, intake forms.
...
- [Forms — Premium Design Guide](.claude/skills/guides/forms-design-guide/SKILL.md) — Author polished Forms with theme presets, layout variants, field-level styling overrides, welcome / thank-you screens, progress indicators, transitions, brand assets, accessibility, and the 14-rule validator.
