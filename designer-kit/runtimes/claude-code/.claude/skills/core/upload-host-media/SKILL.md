...
description: "media_* MCP namespace: upload images, files, videos to the SpiderMedia CDN. Includes upload_local_file / upload_local_directory for agents with filesystem access (no tunnel required)."
---
# upload-host-media
